...
def main():
    ...
    for idx, test in enumerate(tests):
        ...
        if test in models:
            ...
            # Create violin plots with consistent colors for lithologies
            sns.violinplot(data=combined_data_exhumed, x='model', y='tin', hue='lithology', scale='width', palette=lithology_colors, width=0.5, ax=ax[0, 0], legend=False)
            sns.violinplot(data=combined_data_exhumed, x='model', y='tmax', hue='lithology', scale='width', palette=lithology_colors, dodge=True, ax=ax[0, 1], legend=False)
            sns.violinplot(data=combined_data_exhumed, x='model', y='tfin', hue='lithology', scale='width', palette=lithology_colors, width=0.5, ax=ax[0, 2], legend=False)

            sns.violinplot(data=combined_data_stagnant, x='model', y='tin', hue='lithology', scale='width', palette=lithology_colors, width=0.5, ax=ax[1, 0], legend=False)
            sns.violinplot(data=combined_data_stagnant, x='model', y='tmax', hue='lithology', scale='width', palette=lithology_colors, dodge=True, ax=ax[1, 1], legend=False)
            sns.violinplot(data=combined_data_stagnant, x='model', y='tfin', hue='lithology', scale='width', palette=lithology_colors, width=0.5, ax=ax[1, 2], legend=False)
