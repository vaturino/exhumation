...
def main():
    ...
    for idx, test in enumerate(tests):
        if test in models:
            ...
            gs1 = gridspec.GridSpec(1, 3)  # 1 rows, 3 columns with custom heights
            ...
            ax_tin_exhumed = fig1.add_subplot(gs1[0])
            ...
            ax_tmax_exhumed = fig1.add_subplot(gs1[1])
            ...
            ax_tfin_exhumed = fig1.add_subplot(gs1[2])
            ...
            plt.tight_layout()
            exhumed_output_file = f"{output_dir}/ridge_plot_grid_{test}_exhumed.png"
            plt.savefig(exhumed_output_file)
            plt.close()  # Close the figure after saving to free up memory
            ...
            ax_tin_stagnant = fig2.add_subplot(gs2[0])
            ...
            ax_tmax_stagnant = fig2.add_subplot(gs2[1])
            ...
            ax_tfin_stagnant = fig2.add_subplot(gs2[2])
            ...
            plt.tight_layout()
            final_output_file = f"{output_dir}/ridge_plot_grid_{test}_stagnant.png"
