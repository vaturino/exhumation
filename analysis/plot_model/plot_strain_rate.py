...
def main():
    ...
    for ind_m, m in tqdm(enumerate(configs['models'])):
        ...
        plot_loc = f"{plot_loc_mod}/Strain_rate_velocity/"
        ...
        for t in [100, 0]:
            ...
            p1 = a1[0].tripcolor(triang, data["logSR"], cmap='RdBu_r', shading='gouraud', vmin=-17, vmax=-12)
            a1[0].tricontour(triang, data["comp"], levels = [1.0], colors='black', linewidths=1, alpha = 0.5)
            ...
            cbar.set_label('log(${\dot{\epsilon}}$)', rotation=90, labelpad=1, fontsize=font_sz)
